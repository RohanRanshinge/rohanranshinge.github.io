...
<div style="display: flex; align-items: start; gap: 20px; margin-bottom: 20px;">
  <img src="https://upload.wikimedia.org/wikipedia/commons/5/5f/TheHomeDepot.svg" width="50">
  <div>
...
<div style="display: flex; align-items: start; gap: 20px; margin-bottom: 20px;">
  <img src="https://upload.wikimedia.org/wikipedia/commons/c/cd/Accenture.svg" width="80">
  <div>
...
<div style="display: flex; align-items: start; gap: 20px; margin-bottom: 20px;">
  <img src="https://upload.wikimedia.org/wikipedia/commons/6/67/UCD_GSM_logo.PNG" width="80">
  <div>
    **University of California, Davis** *Master of Science, Business Analytics* | *Sept 2018 - July 2019*
...
<div style="display: flex; align-items: start; gap: 20px; margin-bottom: 20px;">
  <img src="https://upload.wikimedia.org/wikipedia/en/3/34/University_of_Mumbai_logo.png" width="80">
  <div>
    **University of Mumbai** *Bachelor of Engineering, Electronics* | *June 2012 - May 2016*
